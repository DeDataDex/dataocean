...
export interface DataoceanMsgCreateVideoResponse {
  /** @format uint64 */
  id?: string;
}
 ...
 */
export interface DataoceanQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: DataoceanParams;
}

export interface DataoceanVideo {
  /** @format uint64 */
  id?: string;
  creator?: string;
  title?: string;
...
/**
 * @title dataocean/dataocean/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/dataocean/dataocean/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DataoceanQueryParamsResponse, RpcStatus>({
      path: `/dataocean/dataocean/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @tags Query
   * @name QueryVideoAll
   * @summary Queries a list of Video items.
   * @request GET:/dataocean/dataocean/video
   */
  queryVideoAll = (
    query?: {
    ...
    this.request<DataoceanQueryAllVideoResponse, RpcStatus>({
      path: `/dataocean/dataocean/video`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/dataocean/dataocean/video/{id}
   */
